<!DOCTYPE html>
<!--
        Descripción: Aplicación Final -- vAltaAnimal.php (Inglés)
        ...
        <div class="col">
            ...
            <form name="insercionValoresTablaDepartamento" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                <fieldset>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="d-flex justify-content-start">
                                    <label for="codAnimal">Reference code:</label>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="d-flex justify-content-start">
                                    <label for="descAnimal">Animal Description:</label>
                                </td>
                                <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                    comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                    que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                            ...
                            <tr>
                                <td class="d-flex justify-content-start">
                                    <label for="fechaNacimientoAnimal">Creation date:</label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <!-- Raza Obligatorio -->
                                <td class="d-flex justify-content-start">
                                    <label for="sexoAnimal">Gender:</label>
                                </td>
                                <td>                                                                                                
                                    ...
                                    <label for="sexoAnimal">Male</label>
                                    ...
                                    if (is_null($aErrores['sexoAnimal']) && isset($_REQUEST['sexoAnimal']) && $_REQUEST['sexoAnimal'] == 'hembra') {echo 'checked';}?>
                                           <!-- Si el campo es correcto se queda seleccionado. -->
                                    <label for="sexoAnimal">Female</label>
                                </td>
                                <td class="error">
                                    <?php
                            ...
                            <tr>
                                <td class="d-flex justify-content-start">
                                    <label for="razaAnimal">Race:</label>
                                </td>
                                <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                    comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                    que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                            ...
                            <tr>
                                <td class="d-flex justify-content-start">
                                    <label for="precioAnimal">Animal Price:</label>
                                </td>
                                <td>                                                                                                <!-- El value contiene una operador ternario en el que por medio de un metodo 'isset()'
                                                                                                                                    comprobamos que exista la variable y no sea 'null'. En el caso verdadero devovleremos el contenido del campo
                                                                                                                                    que contiene '$_REQUEST' , en caso falso sobrescribira el campo a '' .-->
                    ...
                    <button class="botones" role="button" aria-disabled="true" type="submit" name="salirAñadirAnimal">Exit</button>
                </fieldset>
            </form>
        </div>
    </div>
